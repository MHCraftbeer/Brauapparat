 ...
 *- Behoben? Timer ist ungenau, geht etwa eine Minute pro Stunde nach, wahrscheinlich wegen der Laufzeit des Programms
*/
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////// Hardware Ports
//shield
...
void timer(){
  ...
  if (timerStart && tempSollErreicht && !timerEnde) { //Verstellt den Timer wenn Automatik 
    ...
    if (icurrentTimerMillis - timerPreviousMillis >= (1000 - runtime/1000)) {
       timerSet--;
